...
$fw_ext_peoples_gallery_image = fw()->extensions->get('people')->get_config('image_sizes');
$fw_ext_peoples_gallery_image = $fw_ext_peoples_gallery_image['gallery-image'];
...
<div id="primary" class="content-area">
			<div id="content" class="site-content people-content" role="main">
...
while (have_posts()):the_post();?>
	...
	<?php
	$thumbnails = fw_ext_people_get_gallery_images();
	...
	<?php foreach ($thumbnails as $thumbnail):
		...
		$image = fw_resize($thumbnail['attachment_id'], $fw_ext_peoples_gallery_image['width'], $fw_ext_peoples_gallery_image['height'], $fw_ext_peoples_gallery_image['crop']);
		?>
															<img src="<?php echo $image?>"
															     class="nivoslider-image"
															     alt="<?php echo $attachment->post_title?>"
															     title="#nivoslider-caption-<?php echo $attachment->ID?>"
															     width="<?php echo $fw_ext_peoples_gallery_image['width']?>"
															     height="<?php echo $fw_ext_peoples_gallery_image['height']?>"
																/>
		<?php endforeach?>
	</div>
