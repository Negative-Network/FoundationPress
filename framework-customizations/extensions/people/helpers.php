...
function fw_ext_people_get_gallery_images($post_id = 0) {
	...
	return isset($options['people-gallery']) ? $options['people-gallery'] : array();
}

/*
 * @return array of terms
 */
function fw_ext_people_get_listing_categories($term_ids, $taxonomy) {
...
function fw_ext_people_get_sort_classes($items, $taxonomy, $categories, $prefix = 'category_') {
